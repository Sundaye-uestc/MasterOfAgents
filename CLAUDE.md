...
- **Git operations**: NEVER run `git commit`, `git push`, or any destructive git action unless the user explicitly asks. Running `git status` or `git diff` for context is fine.
