...
const components: Components = {
  h1: ({ children }) => (
    <h1 className="text-lg font-bold text-gray-100 mt-3 mb-1 border-b border-gray-700 pb-1">{children}</h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-base font-bold text-gray-100 mt-3 mb-1 border-b border-gray-700 pb-1">{children}</h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-sm font-semibold text-gray-200 mt-2 mb-1">{children}</h3>
  ),
  h4: ({ children }) => (
    <h4 className="text-sm font-medium text-gray-300 mt-2 mb-1">{children}</h4>
  ),
  h5: ({ children }) => (
    <h5 className="text-sm font-medium text-gray-400 mt-1 mb-1">{children}</h5>
  ),
  h6: ({ children }) => (
    <h6 className="text-sm font-medium text-gray-500 mt-1 mb-1">{children}</h6>
  ),
  p: ({ children }) => (
  ...
  code: ({ className, children, ...props }) => {
    ...
    if (_inline) {
      return (
        <code className="bg-gray-700 text-gray-200 px-1 py-0.5 rounded text-xs font-mono" {...props}>
          {children}
        </code>
      );
    }
  ...
  pre: ({ children }) => (
    <pre className="bg-gray-900 text-gray-200 rounded-md p-3 my-2 overflow-x-auto text-xs font-mono border border-gray-700">
      {children}
    </pre>
  ),
  table: ({ children }) => (
  ...
  th: ({ children }) => (
    <th className="border border-gray-600 px-2 py-1 text-left font-semibold text-gray-100">{children}</th>
  ),
  td: ({ children }) => (
    <td className="border border-gray-600 px-2 py-1 text-gray-200">{children}</td>
  ),
  hr: () => (
